...
class VideoPlots:
    ...
    def vid_plot(self, dataset, xxx, yyy, bounds):
        ...
        #supplied dataset will have the xxx, yyy
        self.xxx = xxx
        self.yyy = yyy
        self.wd = dataset
        ...
        def parallel_video_maker(i):
            ...
            results = pool.starmap_async(parallel_video_maker,(i))
            pool.close()
#%% 
if __name__ == '__main__':
    ...
    make_videos = pv.vid_plot(main_dataset, wd_bounds, path)
