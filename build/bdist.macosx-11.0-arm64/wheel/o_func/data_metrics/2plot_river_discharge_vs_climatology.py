def plot_climatology(layout="landscape", num_figures=1, save_path=".", sharey=False):
    ...
    if layout == "landscape":
        base_width, base_height = 14, 100  # Significantly increase height
    elif layout == "portrait":
        base_width, base_height = 10, 150  # Dramatically increase height
    else:
    ...
    for fig_idx in range(num_figures):
        ...
        fig.subplots_adjust(hspace=0.6)  # Increase spacing between rows
